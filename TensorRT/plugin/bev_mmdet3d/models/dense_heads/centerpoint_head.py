...
from ...core.post_processing import circle_nms
...
class CenterHead(BaseModule):
        ...
        for task_id, preds_dict in enumerate(preds_dicts):
            ...
            if self.task_specific:
                ...
                for reg_task_id in range(len(name_list)):
                    ...
                    loss_dict[
                        f"task{task_id}.loss_%s" % (name_list[reg_task_id])
                    ] = loss_bbox_tmp
    ...
    def get_task_detections(
        self, batch_cls_preds, batch_reg_preds, batch_cls_labels, img_metas, task_id
    ):
        ...
        for i, (box_preds, cls_preds, cls_labels) in enumerate(
            ...
            factor = self.test_cfg.get("nms_rescale_factor", default_val)[task_id]
            ...
            top_scores = cls_preds.squeeze(-1) if cls_preds.shape[0] > 1 else cls_preds
