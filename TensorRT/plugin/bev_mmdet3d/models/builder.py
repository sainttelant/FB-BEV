...
# Assuming MMCV_MODELS is already defined somewhere in your code
if "bev_mmdet3d" not in MMCV_MODELS.children:
    MODELS = Registry("models", parent=MMCV_MODELS)
else:
    print('Scope bev_mmdet3d already exists in model registry')
    MODELS = MMCV_MODELS.children["bev_mmdet3d"]  # Use the existing registry

# Assign MODELS to other variables
