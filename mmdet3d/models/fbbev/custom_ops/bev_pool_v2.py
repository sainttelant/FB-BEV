...
import sys
import os
# append root path of project
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '../../..')))

#from bev_mmdet3d.ops.bev_pool_v2 import bev_pool_v2_gpu
from TensorRT.plugin.bev_mmdet3d.ops.bev_pool_v2 import bev_pool_v2_gpu 
